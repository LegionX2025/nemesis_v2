document.addEventListener('DOMContentLoaded', () => {
    ...
    style.innerHTML = `
        ...
        /* CORPORATE INTELLIGENCE LIGHT FOOTER */
        #global-footer {
            position: fixed;
        ...
        .status-dot {
            ...
            box-shadow: 0 0 8px rgba(16, 185, 129, 0.5); animation: pulse-fast 2s infinite alternate;
        }
        @keyframes pulse-fast { from { opacity: 0.6; } to { opacity: 1; transform: scale(1.1); } }

        /* Ensure body accounts for fixed nav */
        body { margin-top: 70px !important; margin-bottom: 40px !important; height: calc(100vh - 110px) !important; overflow: hidden; }
