...
IO_POOL = ThreadPoolExecutor(max_workers=500)
            ...
            <div id="initPanel" class="bg-white p-6 rounded-xl shadow-sm border border-blue-200 relative overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="md:col-span-2">
                        <textarea id="traceSeeds" class="w-full border border-slate-300 p-3 rounded text-sm font-mono focus:border-blue-500 outline-none h-full" rows="4" placeholder="Enter Seed Wallet(s) or TX Hash(es) (e.g. TRON, ETH, BTC, SOL)&#10;One per line"></textarea>
                    </div>
...
<pre>curl -X POST "http://nemesis.canadacentral.cloudapp.azure.com:8000/api/start_trace" \
  ...
  -d '{"seeds": "0x3b5D...", "target_amount": "1000", "currency": "USD", "chain_override": "AUTO"}'</pre>
                    ...
                    <div class="border border-slate-200 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 bg-slate-50">
                            ...
                            <div class="bg-slate-900 p-3 rounded text-green-400 font-mono text-xs overflow-x-auto shadow-inner">
<pre>curl -X GET "http://nemesis.canadacentral.cloudapp.azure.com:8000/api/tx_info?hash=0xabcd...&chain=ETHEREUM" \
  -H "Authorization: Bearer YOUR_API_KEY"</pre>
                    ...
                    <div class="border border-slate-200 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 bg-slate-50">
                            ...
                            <div class="bg-slate-900 p-3 rounded text-green-400 font-mono text-xs overflow-x-auto shadow-inner">
<pre>curl -X GET "http://nemesis.canadacentral.cloudapp.azure.com:8000/api/fingerprint?address=0x1234...&chain=BSC" \
  -H "Authorization: Bearer YOUR_API_KEY"</pre>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-slate-200 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 bg-slate-50">
                            ...
                            <div class="bg-slate-900 p-3 rounded text-green-400 font-mono text-xs overflow-x-auto shadow-inner">
<pre>curl -X POST "http://nemesis.canadacentral.cloudapp.azure.com:8000/api/generate_narrative" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_API_KEY" \
        ...
        <script>
            ...
            ws.onmessage = (msg) => {
                ...
                if (!allNodesMap.has(d.from)) {
                    let nBg = isFromSeed ? originColor + '20' : '#f8fafc';
                ...
                else if (isToSeed) { destBg = originColor + '20'; destBorder = originColor; }
                ...
                let shadowColor = originColor + '80'; // Hex Alpha 50%
